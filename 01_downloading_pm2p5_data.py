...
PARAMS = {
    ...
    "area": [  # Região geográfica de interesse (coordenadas geográficas da Amazônia Legal
        5.3103480484992946,
        -74.0264933540878332,
        -18.0761089985748562,
        -43.9634603545391229,
...
def downloading_pm2p5_data(PARAMS, PATH):
    ...
    while dt < END_DATE:
        ...
        )  # Último dia do mês em processamento
        params[
            "date"
        ] = f'{dt.strftime("%Y-%m-%d")}/{dt_end.strftime("%Y-%m-%d")}'  # Define o intervalo de datas para o mês
        ...
        for time in times:
            ...
            # Definir o intervalo de previsão de acordo com o horário do modelo
            if (
                time == "00:00"
            ):  # Para a hora "00:00", solicita previsões para os passos 6 e 9 horas
...
if __name__ == "__main__":
    downloading_pm2p5_data(PARAMS, PATH)
